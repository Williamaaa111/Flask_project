...
SURVEY_DATA = {
    ...
    'medium': [
        ...
        {"q": "What does SQL stand for?", "options": ["Structured Question List", "Simple Query Language", "Structured Query Language"], "answer": 2},
...
def register():
    if request.method == 'POST':
        ...
        # --- SUPER ADMIN LOGIC ---
        # The very first user created becomes the Super Admin
